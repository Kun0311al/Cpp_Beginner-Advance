...
int main(){
    ...
    float C = 6.458; // float is use to store the fractional number
    double D = 4.76374; /*double is use to store the big fractional number
    and it store 15 no after the decimal points*/
    bool E = true; // boolean is use to store the bool value for exa true and false
